...
if __name__ == '__main__':
    ...
    argparser.add_argument('--k_spt_test', type=int, help='k shot for support set', default=1)
    argparser.add_argument('--k_qry', type=int, help='k shot for query set', default=1) #15
    argparser.add_argument('--k_qry_test', type=int, help='k shot for query set', default=13)  # 15
